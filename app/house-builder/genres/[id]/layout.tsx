...
export default async function GenreLayout({
  ...
  const headerImagePath = getGenreImagePath('house-builder', genre.code, 'logo_header.png')
  const footerImagePath = getGenreImagePath('house-builder', genre.code, 'logo_footer.png')
